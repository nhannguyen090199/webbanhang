...
var KTDashboard = function() {
    ...
    var dailySales = function() {
        var chartContainer = KTUtil.getByID('total_visits');
        ...
        var chartData = {
            labels: total_visits_labes,
            datasets: [{
                //label: 'Dataset 1',
                backgroundColor: KTApp.getStateColor('success'),
                data: total_visits_visitors
            }, {
                //label: 'Dataset 2',
                backgroundColor: '#f3f3fb',
                data: total_visits_pageViews
            }]
        };
    ...
    var profitShare = function() {        
        if (!KTUtil.getByID('device_chart')) {
            return;
        }
        ...
        var ctx = KTUtil.getByID('device_chart').getContext('2d');
        var myDoughnut = new Chart(ctx, config);
    }

    var userTypeChart = function() {
        if (!KTUtil.getByID('user_type_chart')) {
            return;
        }
        ...
        var ctx = KTUtil.getByID('user_type_chart').getContext('2d');
        var myDoughnut = new Chart(ctx, config);
    }
