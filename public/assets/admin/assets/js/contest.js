    ...
    var ContestCls = function () {
        ...
        var exportExcel = function () {
            $('.btn-export').click(function (e) {
                ...
                $.app.ajax(this, 'admin/contest/contest?action=export' + queryString, {}, function (res) {
                    if (res.code) {
                        $.app.alert.loading(res.message);
                        var checkFile = setInterval(function () {
                            $.app.ajax(null, 'admin/contest/contest?action=export&check=1&filename=' + res.data, {}, function (res2) {
                                if (res2.code) {
