                ...
                {!! Form::open( ['url' => ($item->id ? route($route).'/'.$item->id : route($route)), 'method' => ($item->id ? 'PATCH' : 'POST'), 'class' => 'kt-form kt-form--label-right formData', 'name'=>'formData', 'files'=>true] ) !!}
                    ...
                    <div class="kt-portlet__body">
                        <div class="form-group row">
                            <label for="example-text-input" class="col-2 col-form-label">@lang('admin/cms/category.form_category_category')</label>
                            <div class="col-10">
                                {!! Form::select('parent_id', $selectCategory, $item->id ? $item->parent_id : '', ['class'=>'form-control', 'required']) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-2 col-form-label">@lang('admin/cms/category.form_category_title')</label>
                            <div class="col-10">
                                {!! Form::text('title', $item->id ? $item->title : '', ['class'=>'form-control', 'required']) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-2 col-form-label">@lang('admin/cms/category.form_views')</label>
                            <div class="col-10">
                                {!! Form::select('views', $categoryViews, $item->id ? $item->views : '', ['class'=>'form-control', '']) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-2 col-form-label">@lang('admin/cms/category.form_category_image') (400x300)</label>
                            <div class="col-10">
                                <div class="input-group">
                                    {!! Form::text('image', $item->id ? $item->image : '', ['class'=>'form-control image_value', '']) !!}
                                    <div class="input-group-append">
                                        <button data-size="800,600" data-preview=".image_preview" data-value=".image_value" class="btn-crop-image btn btn-primary" type="button">@lang('admin.common.browse')...</button>
                                    </div>
                                </div>
                        ...
                        <div class="form-group row">
                            <label for="example-text-input" class="col-2 col-form-label">@lang('admin/cms/category.form_category_introtext')</label>
                            <div class="col-10">
                                {!! Form::textarea('introtext', $item->id ? $item->introtext : '', ['class'=>'form-control', '', 'rows'=>'3']) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-2 col-form-label">@lang('admin/cms/category.form_category_fulltext')</label>
                            <div class="col-10">
                                {!! Form::textarea('fulltext', $item->id ? $item->fulltext : '', ['class'=>'form-control editor1', '', 'id'=>'editor1']) !!}
