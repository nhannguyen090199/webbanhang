<table class="table table-hover table-striped">
    ...
    <tr>
        ...
        <th scope="col">#</th>
        <th data-field="title">@lang('admin/system/menu.tb_title')</th>
        <th data-field="created_at">@lang('admin/system/menu.tb_created_at')</th>
        <th data-field="updated_at">@lang('admin/system/menu.tb_updated_at')</th>
        <th data-field="status">@lang('admin/system/menu.tb_status')</th>
    ...
    @foreach($items as $k => $item)
        <tr>
            ...
            <td>
                <a @cannot('permission', $route.'.edit') onclick="return false;" @endcannot href="{{ route($route.'.edit', $item->id) }}">
                    {{ $item->title }}</a><br/>
            </td>
            <td>
                {{ $item->created_at }}
