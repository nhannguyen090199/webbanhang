    ...
    <div class="kt-container  kt-container--fluid ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">
                {{ $item->id ? 'Sửa' : 'Thêm mới' }} Thành viên
            </h3>
                            ...
                            <div class="kt-form__body">
                                <div class="kt-section kt-section--first">
                                    <div class="kt-section__body">
                                        ...
                                        {!! \App\Helpers\AdminHelper::getSelectInput('Phân quyền', 'role_id', $item->role_id ?? '', false, $roles) !!}
                                        {!! \App\Helpers\AdminHelper::getTextInput('Tên', 'name', $item->name ?? '', false) !!}
                                        {!! \App\Helpers\AdminHelper::getCropImageInput('Ảnh đại diện', 'avatar', $item->avatar ?? '', false) !!}
                                        {!! \App\Helpers\AdminHelper::getTextInput('Email', 'email', $item->email ?? '', false) !!}
                                        {!! \App\Helpers\AdminHelper::getTextInput('Mobile', 'mobile', $item->mobile ?? '', false) !!}
                                        @if (!$item->id)
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9">
                                                <div class="input-group">
                                                    ...
                                                    <div class="input-group-append">
                                                        <button class="btn btn-primary btn-generate" type="button"><i class="la la-refresh" style="color: #fff"></i> Generate</button>
                                                    </div>
                                                </div>
                            ...
                            <div class="kt-form__body">
                                <div class="kt-section kt-section--first">
                                    <div class="kt-section__body">
                                        ...
                                        {!! \App\Helpers\AdminHelper::getDateInput('Ngày sinh', 'birthday', $item->birthday ?? '', false) !!}
                                        {!! \App\Helpers\AdminHelper::getTextInput('Address', 'address', $item->address ?? '', false) !!}
                                        {!! \App\Helpers\AdminHelper::getSelectInput('Gender', 'gender', $item->gender ?? '', false, ['Nam', 'Nữ']) !!}
                        ...
                        <div class="kt-form kt-form--label-right">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <div class="input-group">
                                                    {!! Form::text('password_new', '', array('class' => 'form-control password_new', 'placeholder'=>'Password...')) !!}
                                                    <div class="input-group-append">
                                                        <button onclick="$('.password_new').val(makeid()); return false;" class="btn btn-primary" type="button">Generate</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="kt-form__actions">
                                <div class="row">
                                    <div class="col-3"></div>
                                    <div class="col-9">
                                        <button type="submit" class="btn btn-success btn-submit" data-action="apply">Update Password</button>
                                    </div>
                                </div>
                            </div>
                        </div>
