<table class="table table-hover table-striped">
    ...
    <tr>
        ...
        <th scope="col">#</th>
        <th data-field="title">@lang('admin/cms/page.tb_title')</th>
        <th data-field="image">@lang('admin/cms/page.tb_image')</th>
        <th data-field="created_at">@lang('admin/cms/page.tb_created_at')</th>
        <th data-field="updated_at">@lang('admin/cms/page.tb_updated_at')</th>
        <th data-field="status">@lang('admin/cms/page.tb_status')</th>
        <th data-field="id" width="50">@lang('admin/cms/page.tb_id')</th>
