    ...
    <div class="kt-container  kt-container--fluid ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">
                {{ $item->id ? trans('admin.common.edit') : trans('admin.common.add') }} Store
            </h3>
            ...
            <div class="kt-portlet">
                ...
                {!! Form::open( ['url' => ($item->id ? route($route).'/'.$item->id : route($route)), 'method' => ($item->id ? 'PATCH' : 'POST'), 'class' => 'kt-form kt-form--label-right formData', 'name'=>'formData', 'files'=>true] ) !!}
                    ...
                    <div class="kt-portlet__body">
                        {!! \App\Helpers\AdminHelper::getTextInput('Title', 'title', $item->id ? $item->title : '', true) !!}
                        {!! \App\Helpers\AdminHelper::getCropImageInput('Image', 'image', $item->id ? $item->image : '', false, '', '400,200') !!}

                        {!! \App\Helpers\AdminHelper::getTextInput('Email', 'email', $item->id ? $item->email : '', false) !!}
                        {!! \App\Helpers\AdminHelper::getTextInput('Mobile', 'mobile', $item->id ? $item->mobile : '', false) !!}

                        {!! \App\Helpers\AdminHelper::getTextInput('Address', 'address', $item->id ? $item->address : '', false) !!}
                        {!! \App\Helpers\AdminHelper::getTextInput('Coordinates', 'coordinates', $item->id ? $item->coordinates : '', false) !!}
