<table class="table table-hover table-striped">
    ...
    <tr>
        ...
        <th scope="col">#</th>
        <th data-field="title">@lang('admin/cms/contest.category.tb_title')</th>
        <th data-field="image">@lang('admin/cms/contest.category.tb_image')</th>
        <th data-field="created_at">@lang('admin/cms/contest.category.tb_date')</th>
        <th data-field="created_at" width="120">@lang('admin/cms/contest.category.tb_order')</th>
        <th data-field="status">@lang('admin/cms/contest.category.tb_status')</th>
        <th data-field="id">@lang('admin/cms/contest.category.tb_id')</th>
