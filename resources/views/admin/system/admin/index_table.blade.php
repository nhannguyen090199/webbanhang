<table class="table table-hover table-striped">
    ...
    <tr>
        ...
        <th scope="col">#</th>
        <th data-field="title">@lang('admin/system/admin.tb_title')</th>
        <th data-field="image">@lang('admin/system/admin.tb_image')</th>
        <th data-field="created_at">@lang('admin/system/admin.tb_permission')</th>
        <th data-field="created_at">@lang('admin/system/admin.tb_created_at')</th>
        <th data-field="status">@lang('admin/system/admin.tb_status')</th>
    ...
    @foreach($items as $k => $item)
        <tr>
            ...
            <td>
                {{ $item->role->title ?? ($item->role_id == -1 ? 'Full Permission' : 'Custom Permission') }}
            </td>
            <td>
                {{ $item->created_at }}
            </td>
