    ...
    <div class="kt-container  kt-container--fluid ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">
                @lang('admin/system/admin.user_profile.user_profile_title')
            </h3>
...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    ...
    <div class="kt-portlet kt-portlet--tabs">
                ...
                <ul class="nav nav-tabs nav-tabs-space-xl nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-brand" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#kt_user_edit_tab_1" role="tab" aria-selected="true">
                            ...
                            </svg>                       @lang('admin/system/admin.user_profile.general.general_title')
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#kt_user_edit_tab_3" role="tab" aria-selected="false">
                            ...
                            </svg>                        @lang('admin/system/admin.user_profile.password.password_title')
                        </a>
                    </li>
                    @endif
                </ul>
        ...
        <div class="kt-portlet__body">
            {!! Form::open( ['url' => route($route).'/profile', 'method' => 'POST', 'class' => 'kt-form kt-form--label-right formData', 'name'=>'formData', 'files'=>true] ) !!}
                            ...
                            <div class="kt-form__body">
                                <div class="kt-section kt-section--first">
                                    <div class="kt-section__body">
                                        ...
                                        {!! \App\Helpers\AdminHelper::getTextInput( trans('admin/system/admin.user_profile.general.user_fullname'), 'name', $item->name ?? '', false) !!}
                                        {!! \App\Helpers\AdminHelper::getSelectInput(trans('admin/system/admin.user_profile.general.user_gender'), 'gender', $item->gender ?? '', false, ['FeMale', 'Male']) !!}
                                        {!! \App\Helpers\AdminHelper::getCropImageInput(trans('admin/system/admin.user_profile.general.user_avatar'), 'avatar', $item->avatar ?? '', false, '', '400,400') !!}
                                        {!! \App\Helpers\AdminHelper::getTextInput(trans('admin/system/admin.user_profile.general.user_email'), 'email', $item->email ?? '', false) !!}
                                        {!! \App\Helpers\AdminHelper::getTextInput(trans('admin/system/admin.user_profile.general.user_mobile'), 'mobile', $item->mobile ?? '', false) !!}
                                        {!! \App\Helpers\AdminHelper::getDateInput(trans('admin/system/admin.user_profile.general.user_birthday'), 'birthday', $item->birthday ?? '', false) !!}
                                        {!! \App\Helpers\AdminHelper::getTextInput(trans('admin/system/admin.user_profile.general.user_address'), 'address', $item->address ?? '', false) !!}
                                    @if (!$item->id)
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-3 col-form-label">@lang('admin/system/admin.user_profile.password.password_title')</label>
                                            <div class="col-9">
                                                <div class="input-group">
                                                    {!! Form::text(trans('admin/system/admin.user_profile.password.new_password'), '', array('class' => 'form-control password_new', 'placeholder'=>trans('admin/system/admin.user_profile.password.new_password_placeholder'))) !!}
                        ...
                        <div class="kt-form kt-form--label-right">
                                ...
                                <div class="kt-section kt-section--first">
                                    <div class="kt-section__body">
                                        <div class="form-group row d-none">
                                            ...
                                            <div class="col-9">
                                                <div class="input-group">
                                                    {!! Form::text('password_old', '', array('class' => 'form-control password_old', 'placeholder'=>'Old Password...')) !!}
                                                </div>
                                            </div>
                                        </div>

                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-3 col-form-label">@lang('admin/system/admin.user_profile.password.new_password')</label>
                                            <div class="col-9">
                                                <div class="input-group">
                                                    {!! Form::text(trans('admin/system/admin.user_profile.password.new_password'), '', array('class' => 'form-control password_new', 'placeholder'=>trans('admin/system/admin.user_profile.password.new_password'))) !!}
                                                    <div class="input-group-append">
                            ...
                            <div class="kt-form__actions">
                                <div class="row">
                                    <div class="col-3"></div>
                                    <div class="col-9">
                                        <button type="submit" class="btn btn-success btn-submit" data-action="apply">@lang('admin/system/admin.user_profile.password.new_password_update')</button>
                                    </div>
                                </div>
                            </div>
                        </div>
