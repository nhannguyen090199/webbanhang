    ...
    <div class="kt-container  kt-container--fluid ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">
                {{ $item->id ? trans('admin.common.edit') : trans('admin.common.add') }} @lang('admin/cms/member.member')
            </h3>
                ...
                <ul class="nav nav-tabs nav-tabs-space-xl nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-brand" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#kt_user_edit_tab_1" role="tab" aria-selected="true">
                            ...
                            </svg>                        @lang('admin/cms/member.general.general_title')
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#kt_user_edit_tab_3" role="tab" aria-selected="false">
                            ...
                            </svg>                        @lang('admin/cms/member.password.password_title')
                        </a>
                    </li>
                    @endif
                </ul>
                            ...
                            <div class="kt-form__body">
                                <div class="kt-section kt-section--first">
                                    <div class="kt-section__body">
                                        ...
                                        {!! \App\Helpers\AdminHelper::getTextInput(trans('admin/cms/member.general.form_name'), 'name', $item->name ?? '', false) !!}
                                        {!! \App\Helpers\AdminHelper::getSelectInput(trans('admin/cms/member.general.form_gender'), 'gender', $item->gender ?? '', false, ['FeMale', 'Male']) !!}
                                        {!! \App\Helpers\AdminHelper::getCropImageInput(trans('admin/cms/member.general.form_image'), 'avatar', $item->avatar ?? '', false) !!}
                                        {!! \App\Helpers\AdminHelper::getTextInput(trans('admin/cms/member.general.form_email'), 'email', $item->email ?? '', false) !!}
                                        {!! \App\Helpers\AdminHelper::getTextInput(trans('admin/cms/member.general.form_phone'), 'mobile', $item->mobile ?? '', false) !!}
                                        {!! \App\Helpers\AdminHelper::getDateInput(trans('admin/cms/member.general.form_birthday'), 'birthday', $item->birthday ?? '', false) !!}
                                        {!! \App\Helpers\AdminHelper::getTextInput(trans('admin/cms/member.general.form_address'), 'address', $item->address ?? '', false) !!}
                                        {!! \App\Helpers\AdminHelper::getNumberInput(trans('admin/cms/member.general.form_fb_id'), 'facebook_id', $item->facebook_id ?? '', false) !!}
                                    @if (!$item->id)
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-3 col-form-label">@lang('admin/cms/member.general.form_password')</label>
                                            <div class="col-9">
                                                <div class="input-group">
                                                    {!! Form::text('password_new', '', array('class' => 'form-control password_new', 'placeholder'=>'Password...')) !!}
                                                    <div class="input-group-append">
                                                        <button onclick="$('.password_new').val(makeid()); return false;" class="btn btn-primary" type="button"><i class="la la-refresh" style="color: #fff"></i> Generate</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="kt-form kt-form--label-right">
                            <div class="kt-form__body">
                                <div class="kt-section kt-section--first">
                                    <div class="kt-section__body">
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-3 col-form-label">@lang('admin/cms/member.password.new_password')</label>
                                            <div class="col-9">
                                                <div class="input-group">
                                                    {!! Form::text('password_new', '', array('class' => 'form-control password_new', 'placeholder'=>trans('admin/cms/member.password.new_password_placeholder'))) !!}
                                                    <div class="input-group-append">
                                                        <button onclick="$('.password_new').val(makeid()); return false;" class="btn btn-primary" type="button">@lang('admin/cms/member.password.new_password_generate')</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="kt-form__actions">
                                <div class="row">
                                    <div class="col-3"></div>
                                    <div class="col-9">
                                        <button type="submit" class="btn btn-success btn-submit" data-action="apply">@lang('admin/cms/member.password.new_password_update')</button>
                                    </div>
                                </div>
                            </div>
                        </div>
