    ...
    <div class="kt-container  kt-container--fluid ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">
                {{ $item->id ? trans('admin.common.edit') : trans('admin.common.add') }} @lang('admin/system/language.language')
            </h3>
            ...
            <div class="kt-subheader__breadcrumbs">
                ...
                <a href="{{ route($route) }}" class="kt-subheader__breadcrumbs-link">
                    @lang('admin/system/language.language')
                </a>
            </div>
        </div>
            ...
            <div class="kt-portlet">
                ...
                {!! Form::open( ['url' => ($item->id ? route($route).'/'.$item->id : route($route)), 'method' => ($item->id ? 'PATCH' : 'POST'), 'class' => 'kt-form kt-form--label-right formData', 'name'=>'formData', 'files'=>true] ) !!}
                    ...
                    <div class="kt-portlet__body">
                        {!! \App\Helpers\AdminHelper::getTextInput(trans('admin/system/language.form_title'), 'title', $item->id ? $item->title : '', true) !!}
                        {!! \App\Helpers\AdminHelper::getTextInput(trans('admin/system/language.form_locate'), 'locale', $item->id ? $item->locale : '', false) !!}
                        {!! \App\Helpers\AdminHelper::getTextInput(trans('admin/system/language.form_code'), 'code', $item->id ? $item->code : '', false) !!}
                    </div>
