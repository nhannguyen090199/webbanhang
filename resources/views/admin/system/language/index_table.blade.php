<table class="table table-hover table-striped">
    ...
    <tr>
        ...
        <th scope="col">#</th>
        <th data-field="title">@lang('admin/system/language.tb_title')</th>
        <th data-field="flag">@lang('admin/system/language.tb_flag')</th>
        <th data-field="default">@lang('admin/system/language.tb_default')</th>
        <th data-field="created_at">@lang('admin/system/language.tb_created_at')</th>
        <th data-field="updated_at">@lang('admin/system/language.tb_updated_at')</th>
        <th data-field="status">@lang('admin/system/language.tb_status')</th>
        <th data-field="id" width="50">ID</th>
    ...
    @foreach($items as $k => $item)
        <tr>
            ...
            <td>
                <a @cannot('permission', $route.'.edit') onclick="return false;" @endcannot href="{{ route($route.'.edit', $item->id) }}">{{ $item->title }}</a>
            </td>
            <td>
                {{ $item->flag }}
            </td>
            <td>
                {!! \App\Helpers\AdminHelper::defaultGroup('default', $item->id, $item->default) !!}
            </td>
            <td>
                {{ $item->created_at }}
            </td>
