<table class="table table-hover table-striped">
    ...
    <tr>
        ...
        <th scope="col">#</th>
        <th data-field="title">@lang('admin/system/role.tb_title')</th>
        <th data-field="ordering" width="120">@lang('admin/system/role.tb_order')</th>
        <th data-field="created_at">@lang('admin/system/role.tb_created_at')</th>
        <th data-field="updated_at">@lang('admin/system/role.tb_updated_at')</th>
        <th data-field="status">@lang('admin/system/role.tb_status')</th>
