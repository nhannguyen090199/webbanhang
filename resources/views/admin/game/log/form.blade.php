...
{{--                                                @endif--}}
                                ...
                                <div class="kt-portlet" style="">
                                    <div class="kt-portlet__head">
                                        ...
                                        <div class="kt-portlet__head-label">
                                            <button type="button" class="btn btn-success send-mail btn-sm"
                                                    data-type="confirm" data-id="{{ $item->id ?? '' }}" data-unlucky="{{ !$item->gift_id }}" style="margin-right: 3px;">
                                                @lang('admin.common.complete') @if ($item->id && $item->logsMail()->where('type', 1)->count() > 0) <i style="font-size: 13px" class="la la-check"></i>@endif
                                            </button>
                                            <button type="button" class="btn btn-info send-mail btn-sm" data-type="unlucky" data-id="{{ $item->id ?? '' }}">
                                                Unlucky @if ($item->id && $item->logsMail()->where('type', 4)->count() > 0) <i style="font-size: 13px" class="la la-check"></i>@endif
                                            </button>
                                            <button type="button" class="btn btn-warning send-mail btn-sm" data-type="invalid" data-id="{{ $item->id ?? '' }}" style="margin-right: 3px;">
                                                @lang('admin.common.invalid') @if ($item->id && $item->logsMail()->where('type', 2)->count() > 0) <i style="font-size: 13px" class="la la-check"></i>@endif
                                            </button>
{{--                                            <button type="button" class="btn btn-info send-mail btn-sm" data-type="share" data-id="{{ $item->id ?? '' }}">--}}
{{--                                                @lang('admin.common.share') @if ($item->id && $item->logsMail()->where('type', 3)->count() > 0) <i style="font-size: 13px" class="la la-check"></i>@endif--}}
{{--                                            </button>--}}
                                        </div>
                                    </div>
